...
// قاعدة بيانات آمنة للنصائح العامة والخبراء لكل الخدمات الشاملة (بدون أي تتبع شخصي)
const generalTips = {
    ...
    "تسريحات المناسبات": "💡 نصيحة عامة: يفضل ارتداء ملابس بأزرار أ الامامية لتجنب إفساد التسريحة أثناء تبديل الملابس.",
