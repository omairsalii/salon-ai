...
- **الأدمن الأول**: التسجيل يعمل مرة واحدة فقط (عند عدم وجود أي أدمن). بعدها يضيف المدير مديرين آخرين من لوحته بكلمة مرور مؤقتة يُجبرون على تغييرها.
- **صلاحيات الأدمن**: إدارة المديرين، تفاصيل كل صالون (موظفون/خدمات/حجوزات/تقييمات)، إيقاف المالك والعميل (تسقط جلساتهم فورًا)، الدخول بدل المالك (ساعة، موسوم ومسجّل)، إلغاء أي حجز، حذف تقييم، إعدادات المنصة (أسعار الباقات، مدة التجربة، إعلان للملاك)، تصدير CSV، وسجل تدقيق لكل ذلك.
